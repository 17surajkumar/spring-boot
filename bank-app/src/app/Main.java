...
public class Main {
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (choice){
                ...
                case "5" -> statments(scanner,bankService);
    ...
    private static void statments(Scanner scanner,BankService bankService) {
        System.out.println("Account number: ");
    ...
    private static void searchAccounts(Scanner scanner,BankService bankService) {
        System.out.println("Enter the Customer name contains: ");
